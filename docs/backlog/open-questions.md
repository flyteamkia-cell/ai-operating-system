...
**[B5] Competitor set.** Which 15–25 accounts, and are they Business/Creator accounts (required for `business_discovery`)? Personal accounts are invisible to the supported API path (ADR-0005).
